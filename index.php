          ...
          <div class="course-carousel">
            <div class="owl-carousel owl-theme">
              ...
              <!-- <div class="item">
                  <div class="single_course">
                    <div class="cour_img">
                      <img src="assets/image/python-image.webp" class="img-fluid" alt="">
                    </div>
                    <div class="course_details">
                      <h4>Data Analysis with Python</h4>
                      <p>Computer Programming, Data Analysis, Data Visualization, Exploratory Data Analysis, General Statistics, Machine Learning, Machine Learning Algorithms, Plot (Graphics), Probability & Statistics, Python Programming, Regression</p>
                    </div>
                  </div>
                </div> -->
